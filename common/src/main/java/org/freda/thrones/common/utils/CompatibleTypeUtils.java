    ...
    public static Object convert(Object value, Class<?> type) {
        ...
        if (value instanceof String) {
            ...
            if (char.class.equals(type) || Character.class.equals(type)) {
                ...
                try {
                    if (type == Date.class) {
                        return DateUtils.parse4y2M2d2h2m2s(string);
                    } else if (type == java.sql.Date.class) {
                        return new java.sql.Date(DateUtils.parse4y2M2d2h2m2s(string).getTime());
                    } else if (type == java.sql.Timestamp.class) {
                        return new java.sql.Timestamp(DateUtils.parse4y2M2d2h2m2s(string).getTime());
                    } else if (type == java.sql.Time.class) {
                        return new java.sql.Time(DateUtils.parse4y2M2d2h2m2s(string).getTime());
                    }
                } catch (Exception e) {
